...
const itinerary = [
  ...
  },
  {
    day: "Dia 1",
    date: "15.09",
    title: "Munique → Andorf → Salzburg (retirada das motos + início do roteiro)",
    description:
      "Transfer em van de aproximadamente 200 km até Andorf, na Áustria, para retirada das motocicletas. Em seguida, início da viagem sobre duas rodas rumo a Salzburg para o primeiro pernoite do tour.",
  },
  {
    day: "Dia 2",
    date: "16.09",
    title: "Salzburg → Stuttgart (Alemanha)",
    description:
      "Dia de deslocamento internacional. Saímos da Áustria rumo à Alemanha, mantendo ritmo confortável e constante até Stuttgart — uma etapa importante para avançar o roteiro com tranquilidade.",
  },
  {
    day: "Dia 3",
    date: "17.09",
    title: "Stuttgart → Lucerna (Suíça)",
    description:
      "Travessia para a Suíça, com mudança clara de cenários ao longo do caminho. Chegada em Lucerna para pernoite, em uma das regiões mais clássicas e bonitas do país.",
  },
  {
    day: "Dia 4",
    date: "18.09",
    title: "Lucerna → Innsbruck (Áustria)",
    description:
      "Retorno aos Alpes. Saímos da Suíça em direção à Áustria, chegando a Innsbruck — cidade cercada por montanhas e referência quando o assunto é estrada alpina e motociclismo europeu.",
  },
  {
    day: "Dia 5",
    date: "19.09",
    title: "Innsbruck → Spielberg",
    description:
      "Dia de chegada ao destino mais esperado do roteiro. Seguimos para Spielberg, onde fica o circuito. Chegada com tempo para entrar no clima do evento e se preparar para o fim de semana do MotoGP.",
  },
  {
    day: "Dia 6",
    date: "20.09",
    title: "Spielberg → MotoGP (dia de evento)",
    description:
      "Dia dedicado ao MotoGP. Imersão total na atmosfera do circuito: movimentação, paddock, arquibancadas e o espetáculo da principal categoria do motociclismo mundial.",
  },
  {
    day: "Dia 7",
    date: "21.09",
    title: "Spielberg → Andorf (encerramento do tour)",
    description:
      "Último dia da viagem: retorno até Andorf para fechamento do roteiro e conclusão oficial da experiência, com despedida do grupo e encerramento do tour.",
  },
]

const includes = [
  "Moto KTM 890 com malas, KM livre e seguro total",
  "Ingresso para o MotoGP (Spielberg)",
...
const gallery = [
  ...
  {
    src: "/images/12.jpg",
    alt: "Clima do evento MotoGP Spielberg",
  },
]

export default function SpielbergTripPage() {
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1.2fr_0.8fr] items-start">
            <div>
              <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                ...
                <span>•</span>
                <span>14 a 21 de Setembro de 2026</span>
              </div>
              <h1 className="mt-3 text-4xl md:text-5xl font-bold text-foreground">MotoGP Spielberg</h1>
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
                Uma jornada premium pelas melhores estradas da Europa Central, passando por Áustria, Alemanha e Suíça, com o MotoGP em Spielberg como ponto alto — velocidade, atmosfera de paddock e a energia única de um fim de semana de Grand Prix.
              </p>
            ...
            <div className="rounded-3xl border border-border bg-card/20 backdrop-blur-md p-6 shadow-lg">
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li>Grupo pequeno: até 8 pilotos (mais exclusividade e atenção ao grupo)</li>
                <li>Moto KTM 890 com seguro total e KM livre</li>
                <li>Ingresso para o MotoGP (Spielberg)</li>
                <li>Roteiro por Áustria, Alemanha e Suíça</li>
                <li>Estradas panorâmicas + experiência em um dos circuitos mais icônicos da Europa</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-6 space-y-4 text-muted-foreground max-w-3xl">
            <p>
              Esta viagem foi desenhada para quem quer viver a Europa sobre duas rodas com conforto, suporte e estradas marcantes — culminando com um fim de semana inteiro no MotoGP em Spielberg, no lendário circuito da Áustria.
            </p>
            <p>
              O roteiro conecta três países e combina deslocamentos bem planejados com trechos cênicos, cruzando regiões clássicas da Alemanha e os cenários suíços até retornar aos Alpes austríacos. Chegamos a Spielberg no tempo certo para entrar no clima do evento e aproveitar a experiência completa do circuito.
            </p>
            <p>
              Tudo em grupo reduzido (até 8 pilotos), garantindo mais flexibilidade, segurança e uma vivência premium do início ao fim.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">Programação completa de 14 a 21 de Setembro.</p>
            </div>
          </div>
